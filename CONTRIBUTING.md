...
workflow tests to stay up-to-date. You can do this by running the following command in your conda env (inside Docker container or not)
...
branch. Please note that this file is only used for GitHub workflows.
