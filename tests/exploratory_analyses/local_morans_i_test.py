...
def test_local_morans_i_queen_correctness():
    ...
    Is = [-0.0, 0.07475982388811646, -0.0, 0.32707308155951376, 0.3270730815595137, 0.02567026668185298, 0.06875988330128255, 0.014784750951796788, 0.014784750951796785, 0.04431219450688388, 0.04431219450688389, 0.07606167537417435, 
          0.07674902657188765, 0.07510349948697309, 0.08027860346365057, 0.08027860346365055, 0.0766008275457467, 0.0766008275457467, -0.017419349937576573, -0.0]

    p_sims = [0.001, 0.365, 0.001, 0.056, 0.056, 0.191, 0.355, 0.206, 0.38, 0.201, 0.256, 0.464, 0.351, 0.24, 0.224, 0.386, 0.397, 0.338, 0.299, 0.001]
...
def test_local_morans_i_knn_correctness():
    ...
    p_sims = [0.223, 0.094, 0.082, 0.148, 0.257, 0.465, 0.396, 0.27, 0.469, 0.319, 0.319, 0.115, 0.126, 0.095, 0.087, 0.133, 0.035, 0.054, 0.416, 0.033]
