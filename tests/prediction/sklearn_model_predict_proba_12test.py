...
# c olumns, df, metadata = import_grid(grids=grids)
...
def test_sklearn_model_predict_proba_error():
    ...
    with pytest.raises(InvalidParameterValueException):
        sklearn_model_predict_proba(sklearnMl=Xdf_enh, Xdf=Xdf)
    with pytest.raises(BeartypeCallHintParamViolation):
        sklearn_model_predict_proba(sklearnMl=sklearnMl, Xdf="_")
    with pytest.raises(InvalidParameterValueException):
        sklearn_model_predict_proba(sklearnMl=sklearnMl, Xdf=Xdf_test, igdf=igdf)
