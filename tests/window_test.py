...
def test_extract_window_case1():
    ...
    case1_window_data, case1_window_meta = extract_window(
        raster=raster, center_coords=(case1_easting, case1_northing), center_coord_crs=3067, height=3, width=3
    )
...
def test_extract_window_case2():
    ...
    case2_window_data, case2_window_meta = extract_window(
        raster=raster, center_coords=(case2_easting, case2_northing), center_coord_crs=3067, height=2, width=2
    )
...
def test_extract_window_case3():
    ...
    case3_window_data, case3_window_meta = extract_window(
        raster=raster, center_coords=(case3_easting, case3_northing), center_coord_crs=3067, height=3, width=2
    )
...
def test_extract_window_invalid_window():
    ...
    with pytest.raises(InvalidWindowSizeException):
        extract_window(
            raster=raster, center_coords=(case1_easting, case1_northing), center_coord_crs=3067, height=0, width=0
        )
...
def test_extract_window_out_of_bounds_coordinates():
    ...
    with pytest.raises(CoordinatesOutOfBoundsException):
        extract_window(raster=raster, center_coords=(100, 100), center_coord_crs=3067, height=1, width=1)
...
def test_extract_window_non_matching_crs():
    ...
    with pytest.raises(NonMatchingCrsException):
        extract_window(
            raster=raster, center_coords=(case1_easting, case1_northing), center_coord_crs=4326, height=1, width=1
        )
