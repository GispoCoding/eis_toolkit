...
# all_import_featureclass_test.py
##################################
import pytest
import sys
...
def test_all_import_featureclass_fc():
...
def test_all_import_featureclass_csv():
    """Test functionality import of fc layer."""
...
def test_all_import_featureclass_wrong():
    """Test functionality import with wrong file name."""
    with pytest.raises(InvalidParameterValueException):
        columns , df , urdf , metadata = all_import_featureclass(fields = fields_csv , file = name_wrong , decimalpoint_german = True) 

test_all_import_featureclass_fc()
test_all_import_featureclass_csv()
test_all_import_featureclass_wrong()
