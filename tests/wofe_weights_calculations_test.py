...
def test_weights_calculations( wgts_type, wgts_df_path, expected):
    """Tests if weights_calculations function runs as intended; tests for all three weights type"""
    #expected results 
    # weights dataframe
    ...
    wgts_df, wgts_arr, rst_meta = weights_calculations(ev_rst=ev_rst_, dep_rst= dep_rst_, w_type=wgts_type, stud_cont=2)
