"""
reshape prediction result 
Created Dezember 02 2022
@author: bernd torchala 
""" 
## zu converion-verzeichnis
...
#### Stand:  angefangen
    ...
    ## - Noch eine Datei (geotiff?) ausgeben
    ##    wenn eine Datei (gtiff -datei) ausgegeben wird, dann wird dafür noch ein Name gebraucht.
## offene Fragen:     
