...
def _descriptive_statistics_csv(
    data: pd.DataFrame,
    column: str,
) -> dict:
...
@beartype
def descriptive_statistics_csv(data: pd.DataFrame, column: str) -> dict:
    """Generate descriptive statistics for selected column from csv data.
    ...
    statistics = _descriptive_statistics_csv(data, column)
    return statistics
