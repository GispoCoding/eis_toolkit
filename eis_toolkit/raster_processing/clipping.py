...
def clip(  # type: ignore[no-any-unimported] # noqa: E261,E262
    ...
    Args:
        ...
        polygon (geopandas.GeoDataFrame): A geodataframe containing the polygon(s) to do the clipping with.
    ...
    out_image, out_transform = mask(dataset=raster, shapes=shapes, crop=True, all_touched=True)
