...
def _save_weights(
    ...
    if w_type != 0:
        cols_rename = {'Class': 'Class', 'Point_Count': 'Cmltv. Point Count', 'Count': 'Cmltv. Count',
                       'Act_Count': 'Count_', 'Act_Point_Count': 'Point Count_',
                       'wpls': 'WPlus', 's_wpls': 'S_WPlus', 'wmns': 'WMinus', 's_wmns': 'S_WMinus',
                       'contrast': 'Contrast', 's_contrast': 'S_Contrast', 'Stud_Cont': 'Stud. Contrast',
                       'Rcls': 'Gen_Class', 'W_Gen': 'Gen_Weights', 's_wpls_gen': 'S_Gen_Weights'
                       }
    else:
        cols_rename = {'Class': 'Class', 'Point_Count': 'Point Count', 'Count': 'Count',
                       'wpls': 'WPlus', 's_wpls': 'S_WPlus', 'wmns': 'WMinus', 's_wmns': 'S_WMinus',
                       'contrast': 'Contrast', 's_contrast': 'S_Contrast', 'Stud_Cont': 'Stud. Contrast',
                       }
...
def save_weights(
    ...
    df_weights = _save_weights(df, w_type)
    return df_weights
