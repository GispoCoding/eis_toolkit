...
def sklearn_logistic_regression(
    ...
    Args:
        ...
        - intercept_scaling (float, default=1):
            ...
            In this case, x becomes [x, self.intercept_scaling], i.e. a “synthetic” feature with constant
        ...
        - solver ({'newton-cg', 'lbfgs', 'liblinear', 'sag', 'saga'}, default='lbfgs'):
            ...
            See also Refer to the User Guide for more information regarding LogisticRegression and more
            specifically the Table summarizing solver/penalty supports.
        ...
        - warm_start (default=False):
            ...
            just erase the previous solution. Useless for liblinear solver. See the Glossary.
        - n_jobs (default=None):
            ...
            whether 'multi_class' is specified or not. None means 1 unless in
