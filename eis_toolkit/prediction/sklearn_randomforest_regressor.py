...
@beartype
def _sklearn_randomforest_regressor(
    ...
    max_features: Optional[Union[maxf, int, float]] = 1.0,
...
@beartype
def sklearn_randomforest_regressor(
    n_estimators: Optional[int] = 100,
    ...
    """
      Create of a randmon forest classification model.

    Args:
       - n_estimators (default=100):    The number of trees in the forest.
       - criterion ({“squared_error”, “absolute_error”, “poisson”}, default=”squared_error”):
          the function to measure the quality of a split.
          Supported criteria are “squared_error” for the mean squared error, which is equal to
          variance reduction as feature selection criterion,
          “absolute_error” for the mean absolute error, and “poisson” which uses reduction in
          Poisson deviance to find splits. Training using “absolute_error” is significantly slower
       ...
       - max_features ({“sqrt”, “log2”, None}, int or float, default=1.0): The number of features to
       ...
       - min_impurity_decrease (default=0.0): A node will be split if this split induces a decrease of the
         impurity greater than or equal to this value.
          ...
          the number of samples in the left child, and N_t_R is the number of samples in the right child.
       ...
       - random_state: RandomState instance or None, default=None: Controls both the randomness of the
       ...
       - warm_start (default=False): When set to True, reuse the solution of the previous call to fit and add
         more estimators to the ensemble, otherwise, just fit a whole new forest. See the Glossary.
       - ccp_alphanon  negative float, default=0.0: Complexity parameter used for Minimal Cost-Complexity Pruning.
         The subtree with the largest cost complexity that is smaller than ccp_alpha will be chosen. By default,
         no pruning is performed. See Minimal Cost-Complexity Pruning for details.
       - max_samples  (default=None): If bootstrap is True, the number of samples to draw from X to train each base
         estimator.
