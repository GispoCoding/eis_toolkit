...
def lineplot(
    ...
    dashes: Union[bool, Sequence] = True,
    markers: Union[bool, Sequence[Union[str, int]], None] = None,
    errorbar: Union[str, Tuple[str, Number]] = ("ci", 95),
    sort: bool = True,
    ...
    **kwargs: Any,
    ...
    Acts as a wrapper for seaborn.lineplot(), for further info see https://seaborn.pydata.org/generated/seaborn.lineplot
    ...
    Args:
        ...
        dashes:
        markers:
        errorbar: Name of errorbar method or a tuple with the method name and a level parameter (for example ("se", 2)).
        sort: If True, the data will be sorted by the x and y variables, otherwise lines will connect points
    ...
    Returns:
        A matplotlib axes containing the lineplot.
